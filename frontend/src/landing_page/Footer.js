      ...
      <div className="container  ">
        <div className="row mt-5">
          <div className="col ">
            ...
            >
              <i
                className="fa-brands fa-x-twitter text-muted mx-3 fs-5"
            ...
            >
              <i
                class="fa-brands fa-instagram text-muted mx-3 fs-5"
                style={{ textDecoration: "none" }}
              ></i>
            </a>
            <a
              href="https://www.linkedin.com/in/patil-aditya-a2a909315/"
              target="_blank"
              rel="noopener noreferrer"
            >
              <i
                class="fa-brands fa-linkedin-in text-muted mx-3 fs-5"
                style={{ textDecoration: "none" }}
              ></i>
            </a>
          </div>
          <div className="col">
            <p className="fs-5 lh-lg fw-normal">Account</p>
            <a
              href=""
              style={{ textDecoration: "none" }}
          ...
          <div className="col">
            <p className="fs-5 lh-lg fw-normal">Support</p>
            <a
              href=""
              style={{ textDecoration: "none" }}
              className="text-muted d-inline-block mb-3"
          ...
          <div className="col">
            <p className="fs-5 lh-lg fw-normal">Company</p>
            <a
              href=""
              style={{ textDecoration: "none" }}
              className="text-muted d-inline-block mb-3"
          ...
          <div className="col">
            <p className="fs-5 lh-lg fw-normal">Quick links</p>
            <a
              href=""
              style={{ textDecoration: "none" }}
              className="text-muted d-inline-block mb-3"
        ...
        <div
          ...
          style={{ fontSize: "13px", color: "rgb(200, 200, 200)" }}
        >
          <a
            href=""
